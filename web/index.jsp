                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 order-lg-1">
                        <div class="p-5">
                            ...
                            <p>Somos una Agencia (Digital) (Visual), dedicada al diseño, desarrollo y posicionamiento Web,
                                enfocados en el crecimiento de su empresa o negocio a través de soluciones y estrategias
                                digitales.
                                ...
                                clientes, implementando diferentes estrategias digitales como el diseño de páginas Web, el
                                posicionamiento web y la administración de redes Sociales</p>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="p-5">
                            ...
                            <p>Profesionales que ofrece soluciones digitales para el desarrollo, diseño y
                                posicionamiento Web. Nuestro enfoque es impulsar el crecimiento de su empresa a través de
                                ...
                                Marketing digital: Páginas web, administración de redes sociales y un optimo posicionamiento en
                                la wed.</p>
                        </div>
                    </div>
                </div>
        ...
        <section>
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 order-lg-1">
                        <div class="p-5">
                            <h2 class="display-4">Misión y Visión</h2>
                            <br>
                            <p><b>Misión</b>
                                Proporcionamos diseños innovadores y desarrollo web con calidad, 
                                ofreciendo a nuestros clientes un acompañamiento permanente que 
                                dé soluciones a todas sus necesidades inmediatas y futuras, generando 
                                confianza a través de una buena experiencia para un crecimiento en conjunto.</p>
                            <p><b>Visión</b>
                                Ser reconocidos como una empresa de calidad que desarrolla
                                nuevas soluciones de negocio digitales y se desempeñe de 
                                forma ética, ofreciendo las mejores herramientas de diseño
                                y desarrollo web que den como resultado el mejor producto y
                                visibilidad para su compañía, Pixel Brant no busca un fin 
                                específico sino una innovación continua.</p>
                        </div>
                    </div>
                </div>
            </div>
